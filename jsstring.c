...
static const char*
checkstring(js_State *J, int idx)
{
...
int
js_runeat(js_State *J, const char *s, int i)
{
	Rune rune = EOF;
	while (i >= 0) {
...
int
js_utfptrtoidx(const char *s, const char *p)
{
	Rune rune;
	int i = 0;
	while (s < p) {
...
static void
Sp_substring_imp(js_State *J, const char *s, int a, int n)
{
